...
def command_switch(name, priority, ):
	...
	switch_obj.cmd('ovs-vsctl set Bridge '+name+' protocols=OpenFlow13'); switch_obj.cmd('ovs-vsctl set Bridge', name, 'stp_enable=true', 
'other_config:stp-priority=%d' % priority)

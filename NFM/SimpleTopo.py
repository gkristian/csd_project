...
class SimpleTopo( Topo ):
	def __init__( self ):
		...
		# Add client zone 1
		u1 = self.addHost('u1', ip='10.0.0.1/8', mac='00:00:00:00:00:01')
		u2 = self.addHost('u2', ip='10.0.0.2/8', mac='00:00:00:00:00:02')
		...
		try:
			...
			#self.addLink(s2, s3, bw=20, loss=10)
			#self.addLink(s1, s3, bw=30, loss=10)
			#self.addLink(s3, s4)
			#self.addLink(s3, s5)
			#self.addLink(s4, s6)
			#self.addLink(s5, s6)

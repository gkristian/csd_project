...
"""
class StanfordSTPBridge( OVSBridge ):
	prio = 1000
	def start( self , *args, **kwargs):
		OVSSwitch.start(self, *args, **kwargs)
		StanfordSTPBridge.prio += 1
		self.cmd('ovs-vsctl set-fail-mode', self, 'standalone')
		self.cmd('ovs-vsctl set-controller', self)
		self.cmd('ovs-vsctl set Bridge', self, 'stp_enable=true', 'other_config:stp-priority=%d' % StanfordSTPBridge.prio )

switches = { 'ovs-stp': StanfordSTPBridge }
"""
...
class StanfordTopo( Topo ):
        def __init__( self ):
                ...
                self.addLink(b1, s5, bw=1000)
                self.addLink(b2, s6, bw=1000)
                self.addLink(b2, s7, bw=1000)
                self.addLink(b2, s8, bw=1000)
                self.addLink(b2, s9, bw=1000)
                self.addLink(b2, s10, bw=1000)

                # Add links from backbone switches to leaf switch o4a, 1 Gbps
                self.addLink(b1, o4, bw=1000)
                self.addLink(b2, o4, bw=1000)

                # link togheter spine and leaf switches, 100 Mbps
                self.addLink(s1, p1, bw=100)
                self.addLink(s1, p5, bw=100)
                self.addLink(s2, o3, bw=100)
                self.addLink(s2, p4, bw=100)
                self.addLink(s2, o6, bw=100)
                self.addLink(s3, p3, bw=100)
                self.addLink(s3, p6, bw=100)
                self.addLink(s4, o1, bw=100)
                self.addLink(s4, o2, bw=100)
                self.addLink(s4, o5, bw=100)
                self.addLink(s4, o7, bw=100)
                self.addLink(s5, p2, bw=100)
                self.addLink(s5, p7, bw=100)
                self.addLink(s6, p1, bw=100)
                self.addLink(s6, p5, bw=100)
                self.addLink(s7, o3, bw=100)
                self.addLink(s7, p4, bw=100)
                self.addLink(s7, o6, bw=100)
                self.addLink(s8, p3, bw=100)
                self.addLink(s8, p6, bw=100)
                self.addLink(s9, o1, bw=100)
                self.addLink(s9, o2, bw=100)
                self.addLink(s9, o5, bw=100)
                self.addLink(s9, o7, bw=100)
                self.addLink(s10, p7, bw=100)
                self.addLink(s10, p2, bw=100)

                # link togheter the pair leaf switches 100 Mbps
                self.addLink(o1, p1, bw=100)
                self.addLink(o2, p2, bw=100)
                self.addLink(o3, p3, bw=100)
                self.addLink(o4, p4, bw=100)
                self.addLink(o5, p5, bw=100)
                self.addLink(o6, p6, bw=100)
                self.addLink(o7, p7, bw=100)

                # Link client zone a and server zone h to leaf switches, 10 Mbps
                self.addLink(o1, u1, bw=10)
                self.addLink(o1, u2, bw=10)
                self.addLink(o1, u3, bw=10)
                self.addLink(o1, u4, bw=10)
                self.addLink(o1, u5, bw=10)
                self.addLink(p1, u6, bw=10)
                self.addLink(p1, u7, bw=10)
                self.addLink(p1, u8, bw=10)
                self.addLink(p1, u9, bw=10)
                self.addLink(p1, u10, bw=10)
                self.addLink(o2, h1, bw=10)
                self.addLink(o2, h2, bw=10)
                self.addLink(o2, h3, bw=10)
                self.addLink(o2, h4, bw=10)

                # Link client zone b and server zone f to leaf switches, 10 Mbps
                self.addLink(o5, v1, bw=10)
                self.addLink(o5, v2, bw=10)
                self.addLink(o5, v3, bw=10)
                self.addLink(o5, v4, bw=10)
                self.addLink(o5, v5, bw=10)
                self.addLink(p7, v6, bw=10)
                self.addLink(p7, v7, bw=10)
                self.addLink(p7, v8, bw=10)
                self.addLink(p7, v9, bw=10)
                self.addLink(p7, v10, bw=10)
                self.addLink(o7, f1, bw=10)
                self.addLink(o7, f2, bw=10)
                self.addLink(o7, f3, bw=10)
                self.addLink(o7, f4, bw=10)

...
opts = [cfg.StrOpt('address', default='127.0.0.1',
        ...
        cfg.IntOpt('max_udp_msg_size', default=6343,
...
"""
ovs-vsctl -- set bridge SWITCH netflow=@netflow -- --id=@netflow create NetFlow
targets=\"127.0.0.1:6343\" active-timeout=10
...
class NetFlowMonitor(app_manager.RyuApp):
    def __init__(self, *args, **kwargs):
        super(NetFlowMonitor, self).__init__(*args, **kwargs)

...
class StanfordTopo( Topo ):
        def __init__( self ):
                ...
                self.addLink(b1, s1, bw=100)
                self.addLink(b1, s2, bw=100)
                self.addLink(b1, s3, bw=100)
                self.addLink(b1, s4, bw=100)
                self.addLink(b1, s5, bw=100)
                self.addLink(b2, s6, bw=100)
                self.addLink(b2, s7, bw=100)
                self.addLink(b2, s8, bw=100)
                self.addLink(b2, s9, bw=100)
                self.addLink(b2, s10, bw=100)

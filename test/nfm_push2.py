...
############nfm_dict1={'module':'nfm', 'keylist':['link_utilization']}
from datetime import datetime



nfmpush={'module':'nfm' }
nfmpush['timestamp']=timestamp = datetime.now().strftime("%Y-%m-%d %H:%M:%S.%f")
nfmpush['packet_dropped']={}
nfmpush['link_utilization']={}
nfmpush['link_utilization']['21-23']=98.7
nfmpush['link_utilization']['23-21'] = 98.7
nfmpush['packet_dropped']['1-2']=1
nfmpush['packet_dropped']['2-1']=1
...
response = DMclient.postme(nfmpush)
#######response = DMclient.getme(rest_query_dict_nfm)
print "request is",nfmpush

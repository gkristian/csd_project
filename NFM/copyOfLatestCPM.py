...
class ProjectController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.defines_D = {'bcast_mac': 'ff:ff:ff:ff:ff:ff',
                          ...
                          'metrics_fetch_rest_url': 'http://130.229.146.35:8000/Tasks.txt',
    ...
    def _packet_in_handler(self, ev):
        ...
        if dst_mac == self.defines_D['bcast_mac']: #if dst == 'ff:ff:ff:ff:ff:ff' means its a host that is flooding the network, we gotta learn it
            ...
            if dst_mac in self.net:
                ...
                print "Found shortest path from src mac %r to dst mac %r as %r", src_mac, dst_mac,spath
    ...
    def __fetch_metrics_and_insert_in_graph(self,module_name):
        ...
        if module_name == 'rpm':
            ...
            rpm_what_metrics_to_fetch = {'module': 'rpm'}
            response = DMclient.getme(rpm_what_metrics_to_fetch)
            print response.viewitems()
        ...
        if module_name == 'nfm':
            ...
            self.logger.info("FETCH_METRICS_NFM:  graph = %r", graph)
